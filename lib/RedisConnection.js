...
/** @override */
RedisConnection.prototype.mget = function (keys, opt_args) {
  ...
  this._client.mget(keys,
      ...
      'Redis [mget] key.0: ' + keys[0] + ' key.length: ' + keys.length, opt_args))
  return deferred.promise
    .then(function (vals) {
 ...
 * @param {Object=} opt_args optional arguments to set the request timeout
 * @return {function(Object, Object)} A node-style callback function.
 */
RedisConnection.prototype._makeNodeResolverWithTimeout = function (deferred, opName, opDesc, opt_args) {

  // Indicates if this request has already timeout
  var isTimeout = false
  var startTime = Date.now()
  var self = this
  var reqTimeoutMs = (opt_args && opt_args.requestTimeoutMs) || this._reqTimeoutMs
